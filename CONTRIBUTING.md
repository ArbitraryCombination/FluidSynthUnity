...
1. Make an [Issue](https://github.com/arbitrary-combination/FluidSynthUnity/issues/new)
...
```json
    {
        "dependencies": {
            "com.arbitrary-combination.FluidSynthUnity": "https://github.com/YOUR_USER/FluidSynthUnity.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at arbitrarycombination-report@darkyen.com.
