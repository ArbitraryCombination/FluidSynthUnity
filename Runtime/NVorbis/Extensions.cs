...
namespace NVorbis {
	...
	public static class Extensions {
		...
		public static int Read(this Packet packet, byte[] buffer, int index, int count) {
		...
		/// </summary>
		/// <returns><see langword="true" /> if the bit was a one, otherwise <see langword="false" />.</returns>
		public static bool ReadBit(this Packet packet) {
